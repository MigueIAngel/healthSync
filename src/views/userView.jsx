...
export default function UserView() {
    const navigate = useNavigate();//userViewP
    ...
    return (
        <div className="parent-user overflow-x-hidden">
            ...
            <div className="parent-son flex justify-center items-center h-screen w-screen overflow-x-hidden">
                <div className="container-user ">
                    ...
                    <div className="flex flex-row bg-white items-center">
                        ...
                        <div className="flex flex-row pl-5 items-center">
                            ...
                            <div className="w-px bg-white-100 h-10 ml-5"></div>
                        </div>
                        <div className="flex flex-row pl-5 items-center mr-auto">
                            ...
                            <div className="w-px bg-white h-10 ml-5"></div>
                            
                        </div>
                        <button className="app-color-blue-1 font-semibold text-md app-button-shadow w-40 py-2 rounded-3xl mr-5">Appointments</button>
                        {/* <button className="app-color-blue-1 font-semibold text-md app-button-shadow w-40 py-2 rounded-3xl mr-5" onClick={() => { navigate("/userViewP"); }} >Patient View</button> */}
                    ...
                    <div className="flex flex-col app-bg-white-1 px-12 pb-10">
                        ...
                        <div className="flex flex-row">
                            <div className="flex flex-col w-40 bg-white pl-5 py-3 rounded-tl-2xl rounded-tr-2xl bg-white active">
                                ...
                                <span className="text-md app-color-blue-1 font-semibold">Patients List</span>
                            </div>
                        </div>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th className="text-left text-xs app-color-black pb-5">Patient</th>
                                    <th className="text-left text-xs app-color-black pb-5">Contact</th>
                                    <th className="text-left text-xs app-color-black pb-5">Appointment</th>
                            ...
                            <tbody>
                                <tr className="app-border-1">
                                    ...
                                    {/* vitalsDoc */ }
                                    <td>
                                        <button class="flex items-center justify-center app-button-shadow w-32 py-2 rounded-3xl " onClick={() => { navigate("/vitalsDoc"); }}>
