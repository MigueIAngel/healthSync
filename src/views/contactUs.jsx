    ...
    return (
        <div className="relative h-screen w-full bg-[url('/src/img/bg_oficial.png')] bg-no-repeat bg-center bg-fixed bg-cover overflow-y-visible md:overflow-y-hidden">
          ...
          <div className="bg-white w-full h-full lg:bg-opacity-0 " >
                ...
                <section class="mb-32 text-gray-800 mt-16">
                    ...
                    <div class="flex flex-wrap">
                        <div class="grow-0 shrink-0 basis-auto mb-12 lg:mb-0 w-full lg:w-5/12 px-3 lg:px-6">
                            ...
                            <div class="form-group mb-6">
                                ...
                                ease-in-out
                                m-0
                                focus:text-nav-blue focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput7"
                                placeholder="Name"/>
                            </div>
                            <div class="form-group mb-6">
                                ...
                                ease-in-out
                                m-0
                                focus:text-nav-blue focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput8"
                        ...
                        <div class="grow-0 shrink-0 basis-auto w-full lg:w-7/12">
                            ...
                            <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                ...
                                <div class="grow ml-6">
                                    ...
                                    <p class="text-nav-blue">support@example.com</p>
                                    <p class="text-nav-bluenav-blue">+1 234-567-89</p>
                                </div>
                                </div>
                            </div>
                            <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                ...
                                <div class="grow ml-6">
                                    ...
                                    <p class="text-nav-blue">sales@example.com</p>
                                    <p class="text-nav-blue">+1 234-567-89</p>
                                </div>
                                </div>
                            </div>
                            <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                ...
                                <div class="grow ml-6">
                                    ...
                                    <p class="text-nav-blue">press@example.com</p>
                                    <p class="text-nav-blue">+1 234-567-89</p>
                                </div>
                                </div>
                            </div>
                            <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                ...
                                <div class="grow ml-6">
                                    ...
                                    <p class="text-nav-blue">bugs@example.com</p>
                                    <p class="text-nav-blue">+1 234-567-89</p>
                                </div>
                                </div>
                            </div>
