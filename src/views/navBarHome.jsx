        ...
        <nav className="bg-nav-blue ">
          ...
          <div className="flex items-center font-medium justify-around">
            ...
            <div className="md:block hidden">
              <button className="bg-sky-600 text-white font-semibold py-2 px-6 rounded-full hover:bg-white hover:text-nav-blue transition duration-500 ease-in-out  lg:mr-4 " onClick={() => { navigate("/loginUser"); }}>
                Log In
              </button>
              <button className="bg-sky-600 text-white font-semibold py-2 px-6 rounded-full hover:bg-white hover:text-nav-blue transition duration-500 ease-in-out  lg:mr-4 " onClick={() => { navigate("/registerUser"); }}>
                Register 
              </button>
            </div>
